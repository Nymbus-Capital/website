...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Mathieu Poulin-Brière joined Nymbus in 2021 after eight years at Perseus Capital, a quantitative hedge fund. He brings deep expertise in systematic trading strategies and portfolio overlay management, contributing to the firm's fixed income and multi-strategy mandates.",
  ...
  },
  {
    ...
    bio: "Jessica Martins leads Nymbus's quantitative research team, bringing expertise in data science, machine learning, and mathematical modeling. She previously worked at Tower Research Capital, one of the world's leading quantitative trading firms, where she developed systematic FX trading strategies. She holds a PhD in Theoretical Physics.",
  ...
  },
  {
    ...
    education: ["PhD Physics", "M.Sc. Financial Engineering"],
  ...
  },
  {
    ...
    designations: ["CFA", "Financial Planner"],
