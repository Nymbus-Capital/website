...
export const funds: Fund[] = [
  {
    ...
    descriptionFr:
      "Une stratégie à revenu fixe court terme gérée systématiquement avec des critères de durabilité intégrés, conçue pour les investisseurs recherchant des rendements stables avec un risque de durée inférieur et un alignement ESG.",
  ...
  },
  {
    ...
    distributionHistory: [
      { exDate: '2025-02-28', payDate: '2025-03-14', amount: 0.045, interest: 0.040, capitalGains: 0.005, returnOfCapital: 0 },
      { exDate: '2024-11-29', payDate: '2024-12-13', amount: 0.044, interest: 0.039, capitalGains: 0.005, returnOfCapital: 0 },
      { exDate: '2024-08-30', payDate: '2024-09-13', amount: 0.043, interest: 0.038, capitalGains: 0.005, returnOfCapital: 0 },
      { exDate: '2024-05-31', payDate: '2024-06-14', amount: 0.042, interest: 0.037, capitalGains: 0.005, returnOfCapital: 0 },
    ],
    riskMetrics: {
      sharpe: 1.34,
      sortino: 2.08,
    ...
    fundDocuments: [
      ...
      { name: 'Management Report of Fund Performance', type: 'MRF', date: '2024-12-31' },
      { name: 'Q4 2024 Commentary', type: 'Commentary', date: '2024-12-31' },
      { name: 'ESG Report 2024', type: 'ESG Report', date: '2024-12-31' },
    ],
    sharpe: 1.34,
    downsideVolatility: 2.1,
    annualReturn: 4.2,
    description:
      "A comprehensive fixed income strategy integrating sustainability principles throughout the investment process, designed for institutional and retail investors seeking above-benchmark returns with ESG accountability.",
    descriptionFr:
      "Une stratégie complète de revenu fixe intégrant les principes de durabilité tout au long du processus d'investissement, conçue pour les investisseurs institutionnels et particuliers recherchant des rendements supérieurs à l'indice de référence avec un responsabilité ESG.",
    managers: ["Sophie Fontaine", "Mark Richardson"],
  },
  {
    slug: "global-low-volatility-strategy",
    name: "Global Low Volatility Strategy",
    shortName: "GLV",
    type: "strategy",
