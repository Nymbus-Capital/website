...
export const funds: Fund[] = [
  {
    ...
    navPerUnit: "$9.95",
    navChange: { dollar: 0.01, percent: 0.10, date: "2025-03-14" },
    riskRating: "Low",
    ...
    geographicBreakdown: [
      { region: 'Canada', weight: 88.5 },
      { region: 'United States', weight: 5.8 },
      { region: 'Europe', weight: 1.5 },
      { region: 'Cash', weight: 4.2 },
    ],
    topHoldings: [
    ...
    descriptionFr:
      "Une stratégie à revenu fixe court terme gérée systématiquement avec des critères de durabilité intégrés, conçue pour les investisseurs recherchant des rendements stables avec un risque de duration plus faible et un alignement ESG.",
  ...
  },
  {
    ...
    descriptionFr:
      "Une stratégie systématique à revenu fixe qui allie une sélection obligataire bonifiée à des principes de durabilité, visant à surperformer l'indice obligataire universel FTSE Canada par une recherche disciplinée et l'intégration ESG.",
    managers: ["Gabriel Cefaloni", "Mathieu Poulin-Brière"],
  },
  {
    slug: "multi-strategy",
    ...
    minSubsequentInvestment: "$100",
    navPerUnit: "$22.45",
    navChange: { dollar: 0.12, percent: 0.54, date: "2025-03-14" },
    riskRating: "Medium",
    ...
    geographicBreakdown: [
      { region: 'Canada', weight: 45.0 },
      { region: 'United States', weight: 28.0 },
      { region: 'Europe', weight: 12.0 },
      { region: 'Asia-Pacific', weight: 8.0 },
    ...
    fees: {
      ...
      performanceFee: '15% above 5% hurdle',
    },
    fundDocuments: [
      { name: 'Fund Fact Sheet', type: 'Fact Sheet', date: '2025-02-28' },
      { name: 'Simplified Prospectus', type: 'Prospectus', date: '2024-06-30' },
    ...
    descriptionFr:
      "Une stratégie alternative diversifiée combinant bonification du revenu fixe, contrats à terme gérés et allocation dynamique d'actifs pour générer des rendements constants dans toutes les conditions de marché avec une faible corrélation aux actions traditionnelles.",
  ...
  },
  {
    ...
    minSubsequentInvestment: "$500,000",
    riskRating: "Medium",
    objectives: "The strategy seeks to generate consistent, positive absolute returns across all market conditions with low correlation to traditional equity and fixed income markets. The strategy targets an annualized return of 8–12% over a full market cycle with volatility significantly below that of global equity markets.",
    investmentFocus: "A diversified portfolio of alternative investment strategies including fixed income enhancement, managed futures (CTA), equity market neutral, volatility arbitrage, and dynamic asset allocation. The strategy employs systematic, rules-based models across all sub-strategies.",
    liquidity: "Monthly",
    rspEligible: false,
    returns: {
      ytd: 3.2,
  ...
  },
  {
    ...
    investmentFocus: "A quantitatively-optimized portfolio of global equities selected for minimum variance characteristics, combined with a fixed income overlay and systematic currency hedging. The strategy employs proprietary risk models and derivatives overlays to enhance risk-adjusted returns.",
    liquidity: "Monthly",
    rspEligible: false,
    returns: {
      ytd: 2.1,
    ...
    fees: {
      managementFee: '0.85%',
      performanceFee: '10% above MSCI World Min Vol',
    },
    fundDocuments: [
    ...
    descriptionFr:
      "Une stratégie multi-actifs sophistiquée utilisant l'optimisation quantitative pour construire des portefeuilles à faible volatilité avec une exposition aux actions mondiales et au revenu fixe, idéale pour les investisseurs institutionnels recherchant des rendements stables et réguliers.",
