...
const methodologySteps = [
  {
    ...
    descriptionFr: 'Nous ingérons et traitons de vastes quantités de données de marché — prix tick par tick, indicateurs de crédit fondamentaux, indicateurs macroéconomiques et ensembles de données alternatifs. Nos cadres de recherche propriétaires identifient des tendances persistantes et des anomalies dans les marchés de titres à revenu fixe et multi-actifs.',
    ...
    detailsFr: ['Modèles propriétaires de notation de crédit', 'Classification macroéconomique en temps réel', 'Intégration de données alternatives (NLP, satellite)', 'Analyse de corrélation inter-actifs'],
  },
  {
    icon: Zap,
