      ...
      <section className="bg-white border-b border-slate-100 pt-8 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            ...
            <p className="text-lg text-slate-600 max-w-2xl">A multidisciplinary team of investment professionals, quantitative researchers, and operations experts united by a passion for systematic investing.</p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Avg. Years Experience</p>
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-1 py-3 overflow-x-auto no-scrollbar">
            {departments.map((dept) => (
              <button key={dept} onClick={() => setActiveDept(dept)} className={cn('px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap', activeDept === dept ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100')}>{dept}</button>
            ))}
          </div>
        </div>
      </section>
