                    ...
                    <tr>
                      ...
                      <th className="px-6 py-4 text-right">
                        <button
                          ...
                          className="flex items-center justify-end gap-2 font-semibold text-slate-900 hover:text-blue-600 w-full"
                        >
                          YTD
                          <SortIcon field="ytd" />
                        </button>
                    ...
                    {filteredAndSortedFunds.map((fund) => (
                      ...
                      >
                        <td className="px-6 py-4">
                          <Link
                            href={`/strategies/${fund.slug}`}
                            className="font-semibold text-blue-600 hover:underline"
                          >
                            {fund.name}
                          </Link>
                        </td>
                        <td className="px-6 py-4 text-slate-600">{fund.assetClass}</td>
                        <td className="px-6 py-4 text-slate-600">{fund.vehicle}</td>
            ...
            {[
              {
                ...
                description:
                  'Delivering consistent long-term outperformance through disciplined systematic investing',
              },
              {
                stat: '0.82',
